<%-- 
    Document   : consultar
    Created on : 4/05/2021, 03:01:54 PM
    Author     : Ulises
--%>
        ...
        <div class="container">
            ...
            <tbody>
                <%
                        ...
                        try{
                            ...
                            %>
                                <tr>
                                    ...
                                    <td align="center"> 
                                     <a class="btn btn-outline-primary" href="Modificar.jsp?id=<%=rs.getInt("id_usu")%>" > Editar </a> 
                    ...
                    <a class="btn btn-outline-primary" href="adminpag.html"> Regresar al menu principal</a>
                    <br>
                    <a class="btn btn-outline-primary" href="adminpag.html"> Registrar nuevo usuario</a>
        </div>
    </body>
</html>
